...
public class OtherProjectAdapter extends BaseAdapter {
private Context context;
private List<Map<String, String>> list;
 public OtherProjectAdapter(Context context,List<Map<String, String>> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		if(convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.suggestproject_item_xml2, parent, false);
		}
