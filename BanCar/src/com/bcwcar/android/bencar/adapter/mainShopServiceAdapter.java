 ...
 * 服务网点list的适配器
 */
public class mainShopServiceAdapter extends BaseAdapter {
	private List<Map<String, String>> list;
	private Context context;
	private Activity activity;
	 public mainShopServiceAdapter(Context context,List<Map<String, String>> list,Activity activity) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(parent.getContext())
					.inflate(R.layout.wangdianlistdiscovery, parent, false);
		}
	...
	shop_data.setOnClickListener(new OnClickListener() {
		...
		address.setText(list.get(position).get("ShortAddress").toString());
		...
		LinearLayout more_project_hanzi=(LinearLayout)convertView.findViewById(R.id.LinearLayout_more_project_text_hanzi001);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int pos, long id) {
				...
				toast= Toast.makeText(context,
					     "仅需支付一元即享犇车活动套餐，到店完成套餐服务后在店支付相应费用",Toast.LENGTH_LONG);
					   toast.setGravity(Gravity.CENTER, 0, 0);
					   toast.show();
//				Toast toast=new Toast(context);
//				toast.makeText(context, "仅需支付一元即享犇车活动套餐，到店完成套餐服务后在店支付相应费用", 0);
//				toast.show();
		...
		more_project.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
			MainDiscovery.refresh_data(position);
			}
		});
		...
		BaseActivity.changeFonts(mListView);
		return convertView;
	}
	// 获取商店信息
