...
public class SlideSwitch extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		paint.setColor(isOn? getResources().getColor(R.color.mainblue):getResources().getColor(R.color.hui));//选择第一个是选中的颜色，第二个是外边框的颜色
		...
		paint.setColor(getResources().getColor(R.color.white));//设置为选择状态的右边的颜色
		canvas.drawPath(sPath, paint);
		canvas.restore();
		// draw center bar
		canvas.save();
		...
		// draw shadow
		paint.setStyle(Style.FILL);
		paint.setColor(getResources().getColor(R.color.inputblack));
		...
		paint.setStyle(Style.FILL);
		paint.setColor(getResources().getColor(R.color.white));//设置中间园的颜色
		canvas.drawPath(bPath, paint);
		paint.setStyle(Style.STROKE);
		paint.setStrokeWidth(bStrokeWidth * 0.5f);
		paint.setColor(isOn? getResources().getColor(R.color.hui):getResources().getColor(R.color.hui));//中间园的边框颜色
		canvas.drawPath(bPath, paint);
