...
public class PaymentResultOrderDetailActivity1 extends BaseActivity{

	private static final String LOG_TAG = PaymentResultOrderDetailActivity1.class.getSimpleName();
...
private Button quzhifu;
	...
	private TextView fapiao,serviceshopname,textbutton;
	...
	public void setPageBody(ViewGroup bodyParentView) {
		LayoutInflater.from(this).inflate(R.layout.body_shop4s_maintain_payment_result_order_detail1, bodyParentView);
		...
		textdanjia=(TextView)findViewById(R.id.fuwudanjia);
		...
		zongjia = (TextView) findViewById(R.id.ourPrice);
		shopadress=(TextView)findViewById(R.id.shopadress);
		numorder=(TextView)findViewById(R.id.numorder);
		youhuiquan=(TextView)findViewById(R.id.youhuiquan);
		fuwuname=(TextView)findViewById(R.id.fuwuname);
		...
		HttpOrder.getMyOrder(new CallbackLogic() {
			...
			public void onBizSuccess(String responseDescription, JSONObject data,JSONObject alldata) {
				...
				try {
					...
					List<Map<String, String>> arrayList=CollectionUtil.jsonArrayToListMap(array);
					...
					numorder.setText(data1.get("Quantity").toString());
                    textdanjia.setText("￥"+arrayList.get(0).get("AfterDiscountSalePrice"));
                    fuwuname.setText(arrayList.get(0).get("AccName"));
					...
					paystatus.setText(arrayList.get(0).get("ProjectName"));
                    ...
                    if (data1.getString("StatusName").toString().equals("退款中")) {
						...
						textbutton.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								...
								Bundle bundle = new Bundle();
		 			    		...
		 			    		PageUtil.jumpTo(PaymentResultOrderDetailActivity1.this, RefundList.class, bundle);
							}
						});
						...
						textbutton.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								...
								Bundle bundle=new Bundle();
								bundle.putString("OrderId", OrderId);
								PageUtil.jumpTo(PaymentResultOrderDetailActivity1.this, RefundReasonActivity.class,bundle);
							}
						});
						...
						textbutton.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
					    		...
					    		try {
									DingDanDataSave.save(PaymentResultOrderDetailActivity1.this, "PaySum", data1.get("ActualPrice").toString());
								} catch (JSONException e) {
									// TODO Auto-generated catch block
									e.printStackTrace();
								}
					    		DingDanDataSave.save(PaymentResultOrderDetailActivity1.this, "OrderId", OrderId);
					    		System.out.println(OrderId+"**********************");
					    		PageUtil.jumpTo(PaymentResultOrderDetailActivity1.this, PaymentMethodActivity.class, bundle);
							}
						});
						...
						textbutton.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								...
								Bundle bundle = new Bundle();
		 			    		bundle.putString("OrderId",OrderId);
		 			    		PageUtil.jumpTo(PaymentResultOrderDetailActivity1.this, EvaluateActivity.class, bundle);
							}
						});
		...
		}, UserLoginStatus.get(PaymentResultOrderDetailActivity1.this,"Token"), OrderId,PaymentResultOrderDetailActivity1.this);
